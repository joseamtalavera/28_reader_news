(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  var Comments = function Comments() {
    ...
    var commentsAreLoading = (0, _reactRedux.useSelector)(_commentsSlice.isLoadingComments);
    (0, _react.useEffect)(function () {
      if (article) {
  ...
  var loadCommentsForArticleId = (0, _toolkit.createAsyncThunk)('comnents/loadCommentsForArticleId', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("api/articles/".concat(articleId, "/comment"));
  ...
  var commentsSlice = (0, _toolkit.createSlice)({
    ...
    extraReducers: function extraReducers(builder) {
      ...
      }).addCase(postCommentForArticleId.pending, function (state) {
