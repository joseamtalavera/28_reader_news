(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var Comments = function Comments() {
      ...
      (0, _react.useEffect)(function () {
        if (article) {
          dispatch((0, _commentsSlice.loadCommentsForArticleId)(article.id));
        }
      }, [dispatch, article]);
    
      if (commentsAreLoading) {
        return /*#__PURE__*/_react["default"].createElement("div", null, "Loading Comments");
      }
    ...
    var postCommentForArticleId = (0, _toolkit.createAsyncThunk)('comment/postCommentForArticleId', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(articleId, comment) {
        var requestBody, response, json;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                requestBody = JSON.stringify(comment);
                _context2.next = 3;
                return fetch("api/articles/".concat(articleId, "/comments"), {
                  method: 'POST',
                  body: requestBody
    ...
    var commentsSlice = (0, _toolkit.createSlice)({
      ...
      extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, loadCommentsForArticleId.pending, function (state, action) {
        state.isLoadingComments = true;
        state.failedToLoadComments = false;
      }), _defineProperty(_extraReducers, loadCommentsForArticleId.fulfilled, function (state, action) {
        state.isLoadingComments = false;
        state.failedToLoadComments = false;
        var _action$payload = action.payload,
            articleId = _action$payload.articleId,
            comments = _action$payload.comments;
        state.byArticleId[articleId] = comments;
      }), _defineProperty(_extraReducers, loadCommentsForArticleId.rejected, function (state, action) {
        state.isLoadingComments = false;
        state.failedToLoadComments = true;
      }), _defineProperty(_extraReducers, postCommentForArticleId.pending, function (state, action) {
        state.createCommentIsPending = true;
        state.failedToCreateComment = false;
      }), _defineProperty(_extraReducers, postCommentForArticleId.fulfilled, function (state, action) {
        state.createCommentIsPending = false;
        state.failedToCreateComment = false;
        var _action$payload2 = action.payload,
            articleId = _action$payload2.articleId,
            comment = _action$payload2.comment;
        state.byArticleId[articleId].push(comment);
      }), _defineProperty(_extraReducers, postCommentForArticleId.rejected, function (state, action) {
        state.createCommentIsPending = false;
        state.failedToCreateComment = false;
      }), _extraReducers)
    });
